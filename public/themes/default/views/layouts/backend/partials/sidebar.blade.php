...
<!--         <p class="designation">Visit Site</p>
 -->
    ...
    <ul class="sidebar-menu">
      ...
      <li><a href="{{ route('backend.categories.index') }}"><i class="fa fa-pie-chart"></i><span>Categories</span></a></li>
      <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Pages</span><i class="fa fa-angle-right"></i></a>
      ...
      <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>News</span><i class="fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
      ...
      <li class="treeview"><a href="#"><i class="fa fa-laptop"></i><span>Notices</span><i class="fa fa-angle-right"></i></a>
        <ul class="treeview-menu">
