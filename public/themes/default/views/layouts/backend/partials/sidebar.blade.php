...
<!--         <p class="designation">Visit Site</p>
 -->
    ...
    <ul class="sidebar-menu">
      ...
      <li class="treeview"><a href="{{ route('backend.pages.index') }}"><i class="fa fa-file-text-o"></i><span>Pages</span><!-- <i class="fa fa-angle-right"></i> --></a>
<!--         <ul class="treeview-menu">
      ...
      <li class="treeview"><a href="{{ route('backend.posts.index') }}"><i class="fa fa-laptop"></i><span>Posts</span>
...
<!--         <ul class="treeview-menu">
      ...
      <li class="treeview"><a href="{{ route('backend.news.index') }}"><i class="fa fa-newspaper-o"></i><span>News</span><!-- <i class="fa fa-angle-right"> --></i></a>
<!--         <ul class="treeview-menu">
      ...
      <li class="treeview"><a href="{{ route('backend.notices.index') }}"><i class="fa fa-bullhorn"></i><span>Notices</span><!-- <i class="fa fa-angle-right"> --></i></a>
<!--         <ul class="treeview-menu">
      ...
      <li class="treeview"><a href="{{ route('backend.adminstrations.index') }}"><i class="fa fa-user-md"></i><span>Adminstrations</span><!-- <i class="fa fa-angle-right"></i> --></a>
<!--         <ul class="treeview-menu">
